             ...
             child: Container(
               ...
               child: Padding(
                 ...
                 child: Column(
                   ...
                   children: [
                     const Text('JOIN THE TRUFIT', style: TextStyle(color: Colors.white, fontSize: 30),),
                     const SizedBox(height: 25),
                     const Text('When you have a goal, you have \n to do the work. Workout plans \n designed to help you achieve your \n fitness goals.',
                     ...
                     Row(
                       ...
                       children: [
                         ...
                         ElevatedButton(
                           onPressed: (){
                             Navigator.pushNamed(context, '/on_board2');
                           },
